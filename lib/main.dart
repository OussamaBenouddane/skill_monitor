...
class BackgroundTaskManager {
  ...
  Future<void> _setupBackgroundNotification() async {
    ...
    const NotificationDetails notificationDetails = NotificationDetails(
      ...
      iOS: DarwinNotificationDetails(
          presentSound: false, presentBadge: false, presentAlert: false),
    );
  ...
  Future<void> performBackgroundCheck() async {
    ...
    try {
      ...
      await prefs.setInt(
          _lastBackgroundCheckKey, DateTime.now().millisecondsSinceEpoch);
...
void main() async {
  ...
  final BackgroundTaskManager backgroundTaskManager =
      BackgroundTaskManager(notificationService);
  ...
  final lifecycleObserver =
      AppLifecycleObserver(notificationService, backgroundTaskManager);
