...
class _SkillCardState extends State<SkillCard> {
  ...
  Widget build(BuildContext context) {
    final levelLabel = SystemConstants.levelLabels[widget.level] ?? 'Unknown Level';
                  ...
                  children: [
                    Row(
                      children: [
                        SleekCircularSlider(
                          ...
                          initialValue: widget.score.clamp(0, widget.maxValue).toDouble(),
                          min: 0,
                    ...
                    if (widget.isExpanded) ...[
                      ...
                      ...widget.habits.map<Widget>((habit) {
                        final habitName = habit['name'] as String? ?? 'Unnamed Habit';
                        final isChecked = widget.selectedHabits.contains(habitName);
                                ...
                                child: SizedBox(
                                  ...
                                  child: Checkbox(
                                    ...
                                    onChanged: (bool? value) {
                                      widget.onHabitChanged(habitName, value, resetDate: value == false);
                                    },
                                  ),
                                ),
                              ),
